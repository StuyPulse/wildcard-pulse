...
export const metadata = { title: "Terms | HAL9000" };
  ...
  return (
    <main className="auth-page">
      <section className="auth-card" style={{ maxWidth: 760 }}>
        ...
        <h2>Who may use HAL9000</h2>
        <p>HAL9000 is an internal scouting workspace for StuyPulse. You must use an authorized <strong>@stuypulse.com</strong> account and follow team directions when using it.</p>
