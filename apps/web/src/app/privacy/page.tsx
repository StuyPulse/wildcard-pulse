...
export const metadata = { title: "Privacy | HAL9000" };

export default function PrivacyPage() {
  return (
    <main className="auth-page">
      <section className="auth-card" style={{ maxWidth: 760 }}>
        <p className="eyebrow">HAL9000</p>
        <h1>Privacy policy</h1>
        <p>Last updated August 26, 2026.</p>
        <h2>What we collect</h2>
        <p>HAL9000 stores the email address, name, and account identifier supplied during sign-in. It also stores scouting submissions, assignments, and other competition information entered by authorized team members.</p>
        <h2>How we use it</h2>
        ...
        <p>Access is limited to authorized HAL9000 users. Data is stored using Supabase and may be processed by the services required to run the application, including Google when you choose Google sign-in.</p>
        <h2>Your choices</h2>
